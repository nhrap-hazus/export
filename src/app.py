import ctypes
import sys
# from hazpy.legacy import Exporting, getStudyRegions
    ...
    def run(self):
        try:
                    ...
                    try:
                        ...
                        if self.inputObj['opt_geojson']:
                            ...
                            try:
                                ...
                                results = studyRegion.getResults()
                                results.toGeoJSON(
                                    self.inputObj['output_directory'] + '/results.geojson')
            ...
            ctypes.windll.user32.MessageBoxW(
                None, u"Unable to open correctly: " + str(sys.exc_info()[1]), u'HazPy - Message', 0)
